...
public class SupportEmail extends AppCompatActivity {
    ...
    private void sendEmail() {
        ...
        String to = "garry.pulseguard@gmail.com";
        ...
        RetrofitClient.getInstance()
                ...
                .enqueue(new Callback<ResponseBody>() {
                    ...
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if (response.code() == HTTP_OK) {
                            try {
                                ...
                                Toast.makeText(SupportEmail.this, obj.getString("message"), Toast.LENGTH_LONG).show();
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable t) {
                        Toast.makeText(SupportEmail.this, t.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
