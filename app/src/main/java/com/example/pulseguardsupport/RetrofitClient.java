...
public class RetrofitClient {
    ...
    private static final String BASE_URL = "https://api.mailgun.net/v3/mg.pulseguard.org/";
    ...
    public com.example.pulseguardsupport.Api getApi() {
        return retrofit.create(com.example.pulseguardsupport.Api.class);
    }
